...
def validate_url_with_whitelist(url: str, whitelist: Optional[Set[str]] = None) -> bool:
...
def validate_url_with_blacklist(url: str, blacklist: Optional[Set[str]] = None) -> bool:
