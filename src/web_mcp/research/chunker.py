...
ABBREVIATIONS = {
    ...
    'www', 'fig', 'figs', 'table', 'tables', 'ed', 'eds',
    'e.g', 'i.e', 'cf', 'viz', 'al', 'ca', 'v', 'vs',
}
...
SENTENCE_STARTERS = {
    ...
    'He\'ll', 'She\'ll', 'It\'ll', 'We\'ll', 'They\'ll', 'You\'ll',
    'He\'d', 'She\'d', 'It\'d', 'We\'d', 'They\'d', 'You\'d',
    'He\'ve', 'She\'ve', 'We\'ve', 'They\'ve',
    'Has', 'Have', 'Had', 'Does', 'Do', 'Did', 'Will', 'Would',
    'Can', 'Could', 'Should', 'May', 'Might', 'Must',
    'When', 'Where', 'Why', 'How', 'Who', 'Which',
    'If', 'Because', 'Although', 'While', 'Since', 'Until',
    'But', 'Or', 'And',
}
